...
package com.vboss.okline.zxing.camera;
...
//            Log.i(TAG, "Device defaultSize width --->>>>> " + defaultSize.width + "  height ---->>>>> " + defaultSize.height);
...
//        Log.i(TAG, "screenResolution x >> " + screenResolution.x + "  y >> " + screenResolution.y);
        ...
        Collections.sort(supportedPreviewSizes, new Comparator<Camera.Size>() {
            ...
            public int compare(Camera.Size size, Camera.Size t1) {
                int sqrt1 = (int) Math.sqrt((screenResolution.x - size.width) * (screenResolution.x - size.width)
                        + (screenResolution.y - size.height) * (screenResolution.y - size.height));
                int sqrt2 = (int) Math.sqrt((screenResolution.x - t1.width) * (screenResolution.x - t1.width)
                        + (screenResolution.y - t1.height) * (screenResolution.y - t1.height));
                if (sqrt1 < sqrt2) {
                    return -1;
                }
                if (sqrt1 > sqrt2) {
...
//            Log.i(TAG, "width >>>>" + supportedPreviewSize.width + " height >>>>>> " + supportedPreviewSize.height);
...
//            Point largestSize = new Point(largeX, largeY);
...
//        Point defaultSize = new Point(largeX, largeY);
...
//        Log.i(TAG, "No supported values match");
    ...
    public static void setLargeY(int cameraResolutionY) {
        largeY = cameraResolutionY;
    }

    public static void setLargeX(int cameraResolutionX) {
        largeX = cameraResolutionX;
    }
