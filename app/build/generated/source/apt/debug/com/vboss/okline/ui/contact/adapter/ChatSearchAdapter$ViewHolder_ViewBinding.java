...
public class ChatSearchAdapter$ViewHolder_ViewBinding<T extends ChatSearchAdapter.ViewHolder> implements Unbinder {
  protected T target;

  @UiThread
  public ChatSearchAdapter$ViewHolder_ViewBinding(T target, View source) {
    this.target = target;
