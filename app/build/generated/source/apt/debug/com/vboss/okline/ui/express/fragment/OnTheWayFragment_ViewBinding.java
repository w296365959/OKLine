...
public class OnTheWayFragment_ViewBinding<T extends OnTheWayFragment> implements Unbinder {
  protected T target;
  ...
  @UiThread
  public OnTheWayFragment_ViewBinding(final T target, View source) {
    this.target = target;
    ...
    view = Utils.findRequiredView(source, R.id.express_send_message_kd_tv, "field 'expressSendMessageKdTv' and method 'onViewClicked'");
    ...
    view = Utils.findRequiredView(source, R.id.express_send_message_kd_iv, "field 'expressSendMessageKdIv' and method 'onViewClicked'");
    ...
    view = Utils.findRequiredView(source, R.id.express_edit_update_send_address_tv, "field 'expressEditUpdateSendAddressTv' and method 'onViewClicked'");
    target.expressEditUpdateSendAddressTv = Utils.castView(view, R.id.express_edit_update_send_address_tv, "field 'expressEditUpdateSendAddressTv'", TextView.class);
    view2131756361 = view;
    view.setOnClickListener(new DebouncingOnClickListener() {
      @Override
      public void doClick(View p0) {
    ...
    view = Utils.findRequiredView(source, R.id.item_express_edit_update_address_ll, "field 'itemExpressEditUpdateAddressLl' and method 'onViewClicked'");
    target.itemExpressEditUpdateAddressLl = Utils.castView(view, R.id.item_express_edit_update_address_ll, "field 'itemExpressEditUpdateAddressLl'", LinearLayout.class);
    view2131756360 = view;
    view.setOnClickListener(new DebouncingOnClickListener() {
      @Override
      public void doClick(View p0) {
    ...
    target.sendUserAndCompanyFl = Utils.findRequiredViewAsType(source, R.id.send_user_and_company_fl, "field 'sendUserAndCompanyFl'", FrameLayout.class);
    ...
    view = Utils.findRequiredView(source, R.id.express_send_message_title_rl, "field 'expressSendMessageTitleRl' and method 'onViewClicked'");
    target.expressSendMessageTitleRl = Utils.castView(view, R.id.express_send_message_title_rl, "field 'expressSendMessageTitleRl'", RelativeLayout.class);
    view2131755843 = view;
    view.setOnClickListener(new DebouncingOnClickListener() {
      @Override
      public void doClick(View p0) {
    ...
    view = Utils.findRequiredView(source, R.id.express_accept_message_title_rl, "field 'expressAcceptMessageTitleRl' and method 'onViewClicked'");
    target.expressAcceptMessageTitleRl = Utils.castView(view, R.id.express_accept_message_title_rl, "field 'expressAcceptMessageTitleRl'", RelativeLayout.class);
    view2131755844 = view;
    view.setOnClickListener(new DebouncingOnClickListener() {
      @Override
      public void doClick(View p0) {
    ...
    target.expressOnTheWayScrollview = Utils.findRequiredViewAsType(source, R.id.express_onTheWay_scrollview, "field 'expressOnTheWayScrollview'", ScrollView.class);
  }
  ...
  public void unbind() {
    ...
    target.sendUserAndCompanyFl = null;
    target.expressMsgAcceptLl = null;
    target.expressSendMessageTitleRl = null;
    target.expressAcceptMessageTitleRl = null;
    target.expressOnTheWayScrollview = null;

    view2131755838.setOnClickListener(null);
    view2131755838 = null;
    view2131755839.setOnClickListener(null);
    view2131755839 = null;
    view2131756361.setOnClickListener(null);
    view2131756361 = null;
    view2131756360.setOnClickListener(null);
    view2131756360 = null;
    view2131755843.setOnClickListener(null);
    view2131755843 = null;
    view2131755844.setOnClickListener(null);
    view2131755844 = null;
