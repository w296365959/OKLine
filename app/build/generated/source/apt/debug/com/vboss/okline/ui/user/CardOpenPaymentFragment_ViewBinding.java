...
public class CardOpenPaymentFragment_ViewBinding<T extends CardOpenPaymentFragment> implements Unbinder {
  protected T target;

  @UiThread
  public CardOpenPaymentFragment_ViewBinding(T target, View source) {
    this.target = target;
