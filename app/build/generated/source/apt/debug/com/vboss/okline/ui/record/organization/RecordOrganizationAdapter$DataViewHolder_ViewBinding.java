...
public class RecordOrganizationAdapter$DataViewHolder_ViewBinding<T extends RecordOrganizationAdapter.DataViewHolder> implements Unbinder {
  protected T target;

  @UiThread
  public RecordOrganizationAdapter$DataViewHolder_ViewBinding(T target, View source) {
    this.target = target;
