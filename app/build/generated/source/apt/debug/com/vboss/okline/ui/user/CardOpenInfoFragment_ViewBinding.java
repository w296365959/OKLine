...
public class CardOpenInfoFragment_ViewBinding<T extends CardOpenInfoFragment> implements Unbinder {
  protected T target;

  @UiThread
  public CardOpenInfoFragment_ViewBinding(T target, View source) {
    this.target = target;
    ...
    target.tvCardOpenInfoEnsure = Utils.findRequiredViewAsType(source, R.id.tv_card_open_info_ensure, "field 'tvCardOpenInfoEnsure'", TextView.class);
  ...
  public void unbind() {
    ...
    target.tvCardOpenInfoEnsure = null;
