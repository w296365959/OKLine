...
import com.vboss.okline.nfc.tech.FeliCa;
...
final class FelicaReader {
    ...
    static void readCard(NfcF tech, NfcCard card) throws IOException {
    ...
    private static Application readApplication(FeliCa.Tag tag, int system)
        ...
        Timber.tag(TAG).i(" IDm : "+tag.getIDm().toString());
        Timber.tag(TAG).i(" PMm : "+tag.getPMm().toString());
