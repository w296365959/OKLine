...
public class WebRtcAudioRecord {
    ...
    public static int _source = AudioSource.VOICE_COMMUNICATION; // AudioSource.DEFAULT;
    public static boolean _noise = false;
    ...
    private int InitRecording(int audioSource, int sampleRate) {
        audioSource = _source;
        Log.d("AudioRecord", "source=" + audioSource);
        /*
...
//					.create(_audioRecord.getAudioSessionId());
        ...
        try {
            ...
            if (!_noise) {
                ...
                for (int i = 0; i < lengthInBytes; i++) {
                    _tempBufRec[i] = (byte) (Math.random() * 128 - 64);
                }
            }
