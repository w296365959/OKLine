...
public class EaseVoiceRecorderView extends RelativeLayout {
    ...
    protected Handler micImageHandler = new Handler() {
        ...
        public void handleMessage(android.os.Message msg) {
            // change image
            // jzy 修复环信发语音可能crash的问题 msg.what 可能过大
            msg.what = msg.what > micImages.length - 1 ? micImages.length - 1 : msg.what;
            try {
    ...
    private void init(Context context) {
        ...
        micImages = new Drawable[]{getResources().getDrawable(R.drawable.ease_record_animate_00),
