...
public class EaseTitleBar extends RelativeLayout{
    ...
    private TextView remarkView;//备注名
    ...
    private void init(Context context, AttributeSet attrs){
        ...
        phoneView = (TextView) findViewById(R.id.ease_tv_phone);
        leftImage = (ImageView) findViewById(R.id.left_image);
        rightLayout = (RelativeLayout) findViewById(R.id.right_layout);
        rightImage = (ImageView) findViewById(R.id.right_image);
        titleView = (TextView) findViewById(R.id.title);
        remarkView = (TextView) findViewById(R.id.tv_remark);
    ...
    public void setRemark(String remark){
        remarkView.setVisibility(VISIBLE);
        remarkView.setText(String.format(context.getString(R.string.remark_username),remark));
    }

    public void setEmptyRemark(){
        remarkView.setVisibility(GONE);
    }
