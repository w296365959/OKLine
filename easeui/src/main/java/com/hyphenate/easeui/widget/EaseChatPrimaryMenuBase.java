...
public abstract class EaseChatPrimaryMenuBase extends RelativeLayout{
    ...
    //modity luoxx 170609 获取当前聊天的类型（群聊，单聊）
    public int getChatType(){
        return activity.getIntent().getIntExtra(EaseConstant.EXTRA_CHAT_TYPE, EaseConstant.CHATTYPE_SINGLE);
    }
    ...
    protected EaseChatPrimaryItemClickListener chatPrimaryClick;
    public void registerMenuItem(EaseChatPrimaryItemClickListener click){
        this.chatPrimaryClick = click;
    }
