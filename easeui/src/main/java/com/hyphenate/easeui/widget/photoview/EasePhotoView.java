...
public class EasePhotoView extends ImageView implements IPhotoView,View.OnClickListener {
	...
	public EasePhotoView(Context context, AttributeSet attr, int defStyle) {
		...
		setOnPhotoTapListener(listeners);
	}

	PhotoViewAttacher.OnPhotoTapListener listeners = new PhotoViewAttacher.OnPhotoTapListener(){
